...
class HabitModel {
  ...
  HabitModel.fromJson(Map<String, dynamic> json) {
    ...
    presetValue = json['presetValue'];
    units = json['units'];
    if (!AppConstant.presetValuesStrings.contains(presetValue)) {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['title'] = title;
    data['isBoolean'] = isBoolean;
    data['presetValue'] = presetValue;
    data['units'] = units;
